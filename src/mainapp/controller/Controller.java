...
public class Controller {
    ...
    public void choise(Event event) throws SQLException{
    ...
    public void play(int target) throws SQLException {
        ...
        if (getImje(target) != null) {
            ...
            switch (fxGameStatus.isEnd(game, fxGameStatus)) {
                ...
                case 1:
                    System.out.println(fxGameStatus);
                    System.out.println(fxPsvm);
                    addRedline(fxGameStatus.getVec(), fxPsvm.getGridRoot().getChildren());
    ...
    public void addRedline(int vec, ObservableList<Node> node) {
